...
<!--            <div class="pull-right form-inline"><br>
        ...
        <br><br>
        <div class="row">
            <div id="calendar" data-toggle='modal' data-target='#add_evento'></div> <!-- Aqui se mostrara nuestro calendario -->
            <br><br>
        </div>
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        ...
                        <select class="form-control" name="class" id="tipo">
                            ...
                            <option value="event-success">Bem Sucedido</option>
                            <option value="event-important">Importante</option>
                            <option value="event-warning">Advertência</option>
