...
$nomeBD = mysql_real_escape_string($_POST['codigo']);
$niverBD = mysql_real_escape_string($_POST['produto']);
$sexoBD = mysql_real_escape_string($_POST['preco']);
$CPFBD = mysql_real_escape_string($_POST['qtd']);
