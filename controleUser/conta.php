                            ...
                            <div class="col-sm-4">
                                <div class="shopper-info">
                                    ...
                                    <form method="post" action="validacaoInsert.php" name="form1">
                                        <input type="text" name="nome" placeholder="Name Completo" value="<?php echo $nomeBDm; ?>"/>
                                        <select nome="sexo">
                                        ...
                                        <input title="Data de Nascimento" nome="nasc" type="date" placeholder="Aniversario" value="<?php echo $niverBD; ?>"/>
